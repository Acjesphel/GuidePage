...
public abstract class GuiderPageTransformer implements ViewPager.PageTransformer {
    ...
    public static GuiderPageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
